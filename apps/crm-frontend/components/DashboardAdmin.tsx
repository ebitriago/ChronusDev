...
import { getProjects, getProject, getProjectSummary, downloadPayrollCSV, getClients, getUsers, createProject, updateProject, assignProjectMember, removeProjectMember, type Project, type ProjectSummary, type Client, type User } from '../app/api';
...
export default function DashboardAdmin() {
  ...
  const [originalMemberIds, setOriginalMemberIds] = useState<string[]>([]); // NEW: Track original members for removal
  ...
  async function handleEditClick(project: Project) {
    ...
    // Fetch full details to get members
    try {
